...
#   function(x) startsWith(x, "current_") || startsWith(x, "selection_") || startsWith(x, "project_") || startsWith(x, "clipboard_"),
#   ls(asNamespace("poof")))
# cat(paste0(relevant_funs, " <- memoise::memoise(", relevant_funs, ")", collapse = "\n"))
# cat(paste0("memoise::forget(", relevant_funs, ")", collapse = "\n"))

clipboard_contains_text             <- memoise::memoise(clipboard_contains_text)
clipboard_is_parsable               <- memoise::memoise(clipboard_is_parsable)
clipboard_text                      <- memoise::memoise(clipboard_text)
...
project_is_package                  <- memoise::memoise(project_is_package)
project_uses_git                    <- memoise::memoise(project_uses_git)
selection_contains_string           <- memoise::memoise(selection_contains_string)
selection_inherits                  <- memoise::memoise(selection_inherits)
...
selection_is_cran_package           <- memoise::memoise(selection_is_cran_package)
selection_is_data_frame             <- memoise::memoise(selection_is_data_frame)
selection_is_empty                  <- memoise::memoise(selection_is_empty)
selection_is_evaluable              <- memoise::memoise(selection_is_evaluable)
selection_is_function               <- memoise::memoise(selection_is_function)
selection_is_in_rmd_chunk           <- memoise::memoise(selection_is_in_rmd_chunk)
selection_is_installed_package      <- memoise::memoise(selection_is_installed_package)
...
selection_is_syntactic_package_name <- memoise::memoise(selection_is_syntactic_package_name)


forget_all <- function() {
  memoise::forget(clipboard_contains_text)
  memoise::forget(clipboard_is_parsable)
  memoise::forget(clipboard_text)
  ...
  memoise::forget(project_is_package)
  memoise::forget(project_uses_git)
  memoise::forget(selection_contains_string)
  memoise::forget(selection_inherits)
  memoise::forget(selection_is_call)
  memoise::forget(selection_is_comment_block)
  memoise::forget(selection_is_comment_line)
  memoise::forget(selection_is_cran_package)
  memoise::forget(selection_is_data_frame)
  memoise::forget(selection_is_empty)
  memoise::forget(selection_is_evaluable)
  memoise::forget(selection_is_function)
  memoise::forget(selection_is_in_rmd_chunk)
  memoise::forget(selection_is_installed_package)
  ...
  memoise::forget(selection_is_syntactic_package_name)
}
